...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`automation/build-release-artifact`](https://github.com/Nischhalsubba/neverwinter-lockbox-vault/tree/automation/build-release-artifact). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on automation/build-release-artifact"]
